...
RSpec.describe RequestQuery do
  ...
  context "#find_all_by_id" do
    ...
    let(:request2) { FactoryBot.create(:request, id: 2) }
    let(:request3) { FactoryBot.create(:request, id: 3) }
