...
ActiveRecord::Schema.define(version: 20190612023855) do
  ...
  add_index "tray_types", ["code", "active"], name: "index_tray_types_on_code_and_active", unique: true, where: "(active = true)", using: :btree
